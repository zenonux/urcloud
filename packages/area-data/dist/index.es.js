...
var areaList = lib.areaList = void 0;
areaList = lib.areaList = {
  province_list: {
    11e4: "\u5317\u4EAC\u5E02",
    12e4: "\u5929\u6D25\u5E02",
    13e4: "\u6CB3\u5317\u7701",
...
const transform = (areaData, addAll = false) => {
  let quanItem = {
    label: "\u5168\u90E8",
    value: ""
  };
  let map = {};
  let arr = addAll ? [__spreadValues({}, quanItem)] : [];
  Object.keys(areaData.province_list).forEach((key, index) => {
    let item = {
      label: areaData.province_list[key],
      value: key,
      children: addAll ? [
        __spreadValues({}, quanItem)
      ] : []
    };
    map[key] = index;
    arr.push(item);
...
const getAreaTree = (addAll = false) => {
